...
LANGUAGE_LIST = [{'iso_code': 'af', 'locale': 'af_ZA', 'name': 'Afrikaans'}
                 ...
                 , {'iso_code': 'en', 'locale': 'en_AU', 'name': 'English (Austrailia)'}
                 ...
                 , {'iso_code': 'fa', 'locale': 'fa_IR', 'name': 'Farsi'}
                 ...
                 , {'iso_code': 'hi', 'locale': 'hi_IN', 'name': 'Hindi'}
                 ...
                 , {'iso_code': 'sl', 'locale': 'sl_SI', 'name': 'Slovene'}
                 ...
                 , {'iso_code': 'ta', 'locale': 'ta_IN', 'name': 'Tamil'}
                 ...
                 , {'iso_code': 'zh', 'locale': 'zh_CN', 'name': 'Chinese'}
